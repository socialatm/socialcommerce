		...
		<tr>
			...
			<td>
				<?php if($default != 1 || $status != 'default'){ ?>
					...
					<span><img id="run_exchange_rate" style="position:relative;left:10px;top:5px;display:none;" src="<?php echo $CONFIG->url."mod/socialcommerce"; ?>/images/working.gif"> </span>
				<?php } ?>
			</td>
		</tr>
		<tr>
