<?php
	...
	$buy_more_link = $CONFIG->wwwroot."pg/socialcommerce/".$_SESSION['user']->username."/all";
	$byu_more = elgg_echo('buy:more');
	$modify_cart_link = $CONFIG->wwwroot."pg/socialcommerce/".$_SESSION['user']->username."/cart/";
	$modify_cart = elgg_echo('modify:cart');
	$change_address_link = $CONFIG->wwwroot."pg/socialcommerce/".$_SESSION['user']->username."/address/";
